    ...
    create() {
        ...
        WebFont.load({
            ...
            active: async () => {
                ...
                // 다시하기 텍스트
                this.add.text(800, 940, "다시하기", { fontFamily: "DOSIyagiBoldface", fontSize: '80px', fill: '#000' })
                    .setOrigin(0.5, 0.5)
                ...
                this.add.text(800, 660, this.nickname, { fontFamily: "DOSIyagiBoldface", fontSize: '80px', fill: '#000' })
                    .setPadding({ top: 4, bottom: 4 })
                    .setOrigin(0.5, 0.5);
                    
                this.add.text(800, 780, this.score, { fontFamily: "DOSIyagiBoldface", fontSize: '80px', fill: '#000' })
                    .setPadding({ top: 4, bottom: 4 })
                    .setOrigin(0.5, 0.5);
            }
        });
