    ...
    create() {
        ...
        WebFont.load({
            ...
            active: async () => {
                ...
                // 다시하기 텍스트
                this.add.text(800, 940, "다시하기", { fontFamily: "DOSGothic", fontSize: '80px', fill: '#263f99' })
                    .setOrigin(0.5, 0.5)
                ...
                if(this.score < 100)
                    this.add.sprite(600, 180, portrait_key).setDisplaySize(400, 400).setOrigin(0, 0).setTintFill(0x263f99).play(portrait_key + ':sad');
                else
                    this.add.sprite(600, 180, portrait_key).setDisplaySize(400, 400).setOrigin(0, 0).setTintFill(0x263f99).play(portrait_key + ':joy');

                this.add.text(800, 660, this.nickname, { fontFamily: "DOSGothic", fontSize: '80px', fill: '#263f99' })
                    .setPadding({ top: 4, bottom: 4 })
                    .setOrigin(0.5, 0.5);
                this.add.text(800, 780, this.score, { fontFamily: "DOSGothic", fontSize: '80px', fill: '#263f99' })
                    .setPadding({ top: 4, bottom: 4 })
                    .setOrigin(0.5, 0.5);
