export class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        WebFont.load({
            ...
            active: () => {
                this.previousSentenceText = this.add.text(400, 280, "", { fontFamily: "DOSGothic", fontSize: '24px', fill: '#c5bdbdff' }).setOrigin(0.5);
                this.currentSentenceText = this.add.text(400, 335, "", { fontFamily: "DOSGothic", fontSize: '36px', fill: '#000' }).setOrigin(0.5);
                this.upcomingSentenceText = this.add.text(400, 390, "", { fontFamily: "DOSGothic", fontSize: '24px', fill: '#c5bdbdff' }).setOrigin(0.5);
            }
        });
        ...
        WebFont.load({
            custom: { families: ['DOSGothic'] },
            active: () => {
                this.nicknameText = this.add.text(230, 100, this.nickname, { fontFamily: "DOSGothic", fontSize: '30px', fill: '#000' });
                this.healthText = this.add.text(230, 150, '체력: 100', { fontFamily: "DOSGothic", fontSize: '30px', fill: '#000' });
                this.scoreText = this.add.text(230, 200, '점수: 0', { fontFamily: "DOSGothic", fontSize: '30px', fill: '#000' });
            }
        });
    ...
    update(_, delta) {
        ...
        if (canvas && textInput) {
            ...
            if (viewportHeight < keyboardThreshold) { // 키보드 등장
                ...
                textInput.style.bottom = (viewportHeight - rect.bottom + 130 * ratio) + "px";
            } else { // 키보드 사라짐
                textInput.style.left = (rect.left + 70 * ratio) + "px";
                textInput.style.bottom = (viewportHeight - rect.bottom + 130 * ratio) + "px";
            }
